...
(defmacro create-spacemacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (comp          (if (eq variant 'dark) (if (true-color-p) "#c56ec3" "#d75fd7") (if (true-color-p) "#af0058" "#8700af")))
        ...
        (green         (if (eq variant 'dark) (if (true-color-p) "#67cd0d" "#67b11d") (if (true-color-p) "#67cd0d" "#5faf00")))
        ...
        (red           (if (eq variant 'dark) (if (true-color-p) "#ff3233" "#d70000") (if (true-color-p) "#ff3233" "#d70008")))
        ...
        (magenta       (if (eq variant 'dark) (if (true-color-p) "#cc1db1" "#af00df") (if (true-color-p) "#cc1db1" "#800080")))
        (yellow        (if (eq variant 'dark) (if (true-color-p) "#f3990d" "#875f00") (if (true-color-p) "#f3990d" "#875f00")))
...
;;;;; nano-modeline
     ...
     '(nano-modeline-status-RW ((,class (:inherit nano-modeline-primary
                                                  :foreground ,bg1))))
     '(nano-modeline-status-RO ((,class (:background "SkyBlue2" :foreground ,keyword))))
;;;;; ediff
