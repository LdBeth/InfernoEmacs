...
(defmacro create-spacemacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;
        ...
        (base-dim      (color-variant "#686868" "#585858" "#a094a2" "#afafd7"))
        ...
        (const         (color-variant "#a45bad" "#d75fd7" "#4e3163" "#8700af"))
        ...
        (comp          (color-variant "#c56ec3" "#d75fd7" "#af0058" "#8700af"))
        (err           (color-variant "#e0211d" "#e0211d" "#e0211d" "#e0211d"))
        (func          (color-variant "#bc6ec5" "#d75fd7" "#6c3163" "#8700af"))
        ...
        (keyword       (color-variant "#4f97d7" "#268bd2" "#3a81c3" "#268bd2"))
        (lnum          (color-variant "#44505c" "#444444" "#a8a8bf" "#af87af"))
        (mat           (color-variant "#86dc2f" "#86dc2f" "#ba2f59" "#af005f"))
        (meta          (color-variant "#5a7fea" "#5566cc" "#da8b55" "#df5f5f"))
