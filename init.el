...
(custom-set-variables
 ...
 '(package-selected-packages
   '(maude-mode corfu dyalog-mode filladapt gnu-elpa-keyring-update pinentry wanderlust flyspell-correct-ivy mwim unfill sly smex which-key counsel ivy paren-face use-package)))
(custom-set-faces
