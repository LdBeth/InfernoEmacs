...
(custom-set-variables
 ...
 '(package-selected-packages
   '(notmuch gnu-elpa-keyring-update pinentry wanderlust flyspell-correct-ivy mwim unfill hl-todo sly smex diminish which-key counsel ivy paren-face use-package)))
(custom-set-faces
