...
(custom-set-variables
 ...
 '(package-selected-packages
   '(orderless emacs-gc-stats vertico ctrlf sudo-edit z3-mode xquery-mode emmet-mode elpher rnc-mode maude-mode corfu dyalog-mode filladapt gnu-elpa-keyring-update pinentry wanderlust mwim unfill sly which-key use-package)))
(custom-set-faces
