...
(custom-set-variables
 ...
 '(package-selected-packages
   '(gnu-elpa-keyring-update pinentry mu-cite wanderlust flyspell-correct-ivy mwim unfill hl-todo sly smex diminish which-key counsel ivy paren-face use-package)))
(custom-set-faces
